...
| 4  | Глубокое Q-обучение | [ipynb](seminars/04_DQN.ipynb) |
| 5  | Оптимизация стратегии | [ipynb](seminars/05_Policy_AC.ipynb) |
| 6  | Актор-критик обучение (DDPG, PPO) | DDPG [ipynb](seminars/06_DDPG.ipynb), PPO [ipynb](seminars/06_PPO.ipynb) |
| 7  | Целеориентированное обучение | [TBA]|
| 8  | Обучение на основе модели мира| [ipynb](seminars/08_MBRL.ipynb) |
| 8  | Decision Transformer| [TBA] |
...
В рамках курса вам необходимо выбрать **один из предложенных проектов** или предложить **собственный вариант**. Выбранный вариант проекта необходимо согласовать.  
...
Готовые проекты необходимо будет отправить за несколько дней до защиты.
